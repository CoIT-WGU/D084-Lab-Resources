...
> **To successfully complete the labs for this course, you will need to first download the lab files by clicking [this link](https://github.com/BGarza-CoIT/D084-Lab-Resources/archive/master.zip).**  The lab instructions should be opened with a browserwill indicate when you will need to use each file to successfully complete each exercise.
