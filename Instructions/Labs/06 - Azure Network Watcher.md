...
Lab files:
 ...
 -  **Labfiles\\Module_06\\Network_Watcher\\01_azuredeploy.json**

 -  **Labfiles\\Module_06\\Network_Watcher\\02_azuredeploy.json**

 -  **Labfiles\\Module_06\\Network_Watcher\\01_azuredeploy.parameters.json**

 -  **Labfiles\\Module_06\\Network_Watcher\\02_azuredeploy.parameters.json**
...
1. From the **Edit template** blade, load the template file **Labfiles\\Module_06\\Network_Watcher\\01_azuredeploy.json**.
...
1. From the **Edit parameters** blade, load the parameters file **Labfiles\\Module_06\\Network_Watcher\\01_azuredeploy.parameters.json**.
...
1. From the **Edit template** blade, load the template file **Labfiles\\Module_06\\Network_Watcher\\02_azuredeploy.json**.
...
1. From the **Edit parameters** blade, load the parameters file **Labfiles\\Module_06\\Network_Watcher\\02_azuredeploy.parameters.json**.
