...
-  **Labfiles\\Module_08\\Load_Balancer_and_Traffic_Manager\\azuredeploy.json**

-  **Labfiles\\Module_08\\Load_Balancer_and_Traffic_Manager\\01_azuredeploy.parameters.json**

-  **Labfiles\\Module_08\\Load_Balancer_and_Traffic_Manager\\02_azuredeploy.parameters.json**
...
1. From the **Edit template** blade, load the template file **Labfiles\\Module_08\\Load_Balancer_and_Traffic_Manager\\azuredeploy.json**.
...
1. From the **Edit parameters** blade, load the parameters file **Labfiles\\Module_08\\Load_Balancer_and_Traffic_Manager\\01_azuredeploy.parameters.json**.
...
1. From the **Edit parameters** blade, load the parameters file **Labfiles\\Module_08\\Load_Balancer_and_Traffic_Manager\\02_azuredeploy.parameters.json**.
