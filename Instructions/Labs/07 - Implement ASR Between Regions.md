...
Lab files:
 ...
 -  **Labfiles\\Module_07\\Azure_Site_Recovery_Between_Regions\\azuredeploy.json**

 -  **Labfiles\\Module_07\\Azure_Site_Recovery_Between_Regions\\azuredeploy.parameters.json**
...
1. From the **Edit template** blade, load the template file **Labfiles\\Module_07\\Azure_Site_Recovery_Between_Regions\\azuredeploy.json**.
...
1. From the **Edit parameters** blade, load the parameters file **Labfiles\\Module_07\\Azure_Site_Recovery_Between_Regions\\azuredeploy.parameters.json**.
